...
const NewEmployeeListPage: React.FC = () => {
    ...
    const [actionType, setActionType] = useState<EmployeeActionType>(EmployeeActionType.Add);
    ...
    const fetchEmployees = async (page = 1, pageSize = 5, filterValue = '') => {
        setLoading(true);
        const response = await fetchData(`?page=${page}&limit=${pageSize}&sort=${'asc'}&sortedColumn=${'name'}&filter=${filterValue}`);
    ...
    const handlePageChange = async (page, pageSize) => await fetchEmployees(page, pageSize);
            ...
            <div className="wrapper">
                ...
                <div id="content" className="content">
                    ...
                    <Box sx={{
                        ...
                        <DataGrid
                            ...
                            components={{
                                ...
                                //LoadingOverlay: LinearProgress,// another way of showing loader while data being fetched from server
                            }}
                        />
                        <Button
                            color='primary'
                    ...
                    <EmployeeAddEditModal
                        ...
                        employees={employees}
                    />
                    <DeleteEmployee id={employeeId} isOpen={deleteDialogOpen} closeModal={handleDeleteModalClose} />
                </div>
            </div>
            <Footer />
        </React.Fragment>
